"""
Django settings for cp_manager project.
...
# SECRET_KEY = 'django-insecure-e8)z(ktko!rxdz_oqj2r^xqkfx5(b#ba1fp#)1^tcbqe!!a=!*'
...
# CRONJOBS = [
    # ('* * * * *', 'cp.cron.fetch_problem', '>> ' + os.path.join(BASE_DIR, 'cron.log') + ' 2>&1'),
# ]
ROOT_URLCONF = 'cp_manager.urls'
